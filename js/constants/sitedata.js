...
export const UI_TRANSLATIONS = {
    en: {
        ...
        contact: {
            ...
            termsModalCloseLabel: 'Close terms notice',
            termsModalEyebrow: 'Before sending',
            termsModalTitle: 'Read and accept the terms',
            termsModalText: 'To send your message, please review the Terms and Conditions and then mark the acceptance checkbox.',
            termsModalRead: 'Read terms',
            termsModalBack: 'Back to form',
    ...
    es: {
        ...
        contact: {
            ...
            termsModalCloseLabel: 'Cerrar aviso de términos',
            termsModalEyebrow: 'Antes de enviar',
            termsModalTitle: 'Lee y acepta los términos',
            termsModalText: 'Para enviar tu mensaje, primero revisa los Términos y Condiciones y luego marca el check de aceptación.',
            termsModalRead: 'Leer términos',
            termsModalBack: 'Volver al formulario',
